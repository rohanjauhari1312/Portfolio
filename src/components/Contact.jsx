...
const LINKS = [
  {
    label: 'GitHub',
    handle: '@rohanjauhari',
    href: 'https://github.com/rohanjauhari',
    color: '#e6edf3',
  ...
  {
    label: 'Instagram',
    handle: '@rohan_jauhari',
    href: 'https://instagram.com/rohan_jauhari',
    color: '#e1306c',
  ...
  return (
    <section id="contact" style={{ background: 'rgba(10,10,10,0.85)', padding: isMobile ? '24px 0 0' : '40px 0 0' }}>
      ...
      <div ref={ref} style={{ maxWidth: 1320, margin: '0 auto', padding: isMobile ? '0 24px' : '0 64px' }}>
        ...
        <div style={{ textAlign: 'center', maxWidth: 680, margin: isMobile ? '0 auto 48px' : '0 auto 64px' }}>
          ...
          <p style={{ ...fade(160), fontSize: 17, color: 'rgba(255,255,255,0.45)', lineHeight: 1.75, margin: '0 0 40px' }}>
            Actively exploring full-time roles in Product Management, Product Analytics, and Product Operations.
            If you&apos;re building in AI, data, or SaaS, I&apos;d love to connect.
          </p>
      ...
      <div style={{
        ...
        <span style={{ fontSize: 13, color: 'rgba(255,255,255,0.3)', letterSpacing: '0.02em', display: 'flex', alignItems: 'center', gap: 6 }}>
          Built with{' '}
          <img src="/claude code.png" alt="Claude Code" style={{ height: 44, objectFit: 'contain' }} />
        </span>
      </div>
    </section>
  )
