    ...
    <section style={{ background: 'rgba(10,10,10,0.85)', padding: isMobile ? '24px 0 48px' : '40px 0 80px' }} id="achievements">
      ...
      <div style={{ maxWidth: 1320, margin: '0 auto', padding: isMobile ? '0 24px' : '0 64px' }}>
        ...
        >
          ...
          <h2 style={{ fontSize: 'clamp(2rem,5vw,3.5rem)', fontWeight: 800, color: '#f5f5f5', letterSpacing: '-0.02em', lineHeight: 1.1, margin: 0, whiteSpace: 'nowrap' }}>
            Testaments of shipments{' '}
            <span style={{ fontSize: '0.55em', fontWeight: 700, opacity: 0.65, verticalAlign: 'middle' }}>—</span>
            {' '}beyond resume.
          </h2>
