...
const PROJECTS = [
  {
    ...
    hasDetail: 'smartcart',
    name: 'SmartCart',
    tagline: 'Multi-agent Grocery Assistant, Real Cart, Real API',
    bullets: [
      'Type **"ramen x3, oat milk, dumplings, under $50, high-protein"** and eight agents parse, search, score, and rank it',
  ...
  },
  {
    ...
    name: 'WatchlessAI',
    tagline: 'Conversational AI that watches your cameras so you don\'t have to',
    bullets: [
      'Point it at any **RTSP stream or video file** — ask "did anyone enter after 3pm?" and get a grounded answer with timestamps',
      'Set alerts in **plain English**: fires only when something genuinely new happens, not when the same situation persists',
      '**Three agentic loops** — Alert engine, Chat agent, Validation agent — each calling tools and deciding next steps independently',
      'Built on **Claude Haiku + FastAPI + OpenCV**, deployed on Railway under **$1/camera/day** in inference cost',
    ],
    gradient: 'linear-gradient(135deg, #001a1f 0%, #03373f 50%, #055160 100%)',
    iconBg: 'linear-gradient(135deg, #0e7490, #22d3ee)',
    icon: 'W',
    accentColor: '#22d3ee',
    tags: ['Agentic AI', 'Computer Vision', 'Claude', 'FastAPI', 'OpenCV', 'Tool calling'],
    metrics: [
      { v: '3', l: 'Agents in loop' },
      { v: '<$1', l: 'Per camera per day' },
      { v: 'Live', l: 'On Railway' },
    ],
    status: 'Personal Project',
  },
  ...
  },
  {
    ...
    tagline: 'Tableau · Order Lifecycle · 20,000 Orders Across 56 Markets',
    bullets: [
      'Mapped the **order lifecycle** across 4 handoffs and found 3 of 4 pain points sit before the food is even picked up',
      '**76% of customers never come back**, and the slow ones leave fastest — discounts move repeat rate by only 0.2 points',
      '**95% of Dashers do 5 orders or fewer** while delivering 68% of volume; new Dashers take 2x as long to reach the store',
      'Shipped **7 prioritized actions** with owners and success metrics, from a week-1 fix to a quarter-long merchant standard',
    ],
    ...
    metrics: [
      ...
      { v: '4', l: 'Pain points, 7 actions' },
      { v: '76%', l: 'Customers never return' },
    ],
    status: 'Case Study',
  },
  {
    ...
    <section style={{ background: 'rgba(10,10,10,0.85)', padding: isMobile ? '24px 0 48px' : '40px 0 80px' }} id="projects">
      ...
      <div style={{ maxWidth: 1320, margin: '0 auto', padding: isMobile ? '0 24px' : '0 64px' }}>
        ...
        >
          ...
          <TypedHeading text="Things I've " suffixText="built." suffixStyle={{ background: 'linear-gradient(90deg, #facc15, #fb923c)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }} style={{
