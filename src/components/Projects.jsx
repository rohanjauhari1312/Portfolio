...
const PROJECTS = [
  ...
  },
  {
    ...
    bullets: [
      ...
      'Identified **2 stores leaking revenue**: one dropping driver records, one recording $0 on 10.5% of orders (~$4,244 unrecorded in a month)',
      '**270 confirmed orders/month** never get delivered — scheduled orders fail at 3.8x the ASAP rate, adding up to 3,240 lost orders a year',
      'Built **Tableau heatmaps** across 20K orders showing this is a nighttime business — 9pm–2am has 15x the volume of morning',
    ],
    ...
    metrics: [
      ...
      { v: '6', l: 'Findings, 6 recommendations' },
      { v: '$4.4K', l: 'Revenue leak found in 1 day' },
    ],
    status: 'Case Study',
  },
  {
