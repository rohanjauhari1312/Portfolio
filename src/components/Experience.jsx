...
const JOBS = [
  ...
  },
  {
    ...
    highlights: [
      ...
      'Drove **33% expansion in clientele** by validating market opportunities, sizing use cases per segment, and developing tailored roadmaps and user journeys',
    ...
    <section style={{ background: 'rgba(10,10,10,0.85)', padding: isMobile ? '24px 0 48px' : '40px 0 80px' }} id="work">
      ...
      <div style={{ maxWidth: 1320, margin: '0 auto', padding: isMobile ? '0 24px' : '0 64px' }}>
        ...
        >
          ...
          <TypedHeading text="Where I made " suffixText="impact." suffixStyle={{ background: 'linear-gradient(90deg, #facc15, #fb923c)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }} style={{
